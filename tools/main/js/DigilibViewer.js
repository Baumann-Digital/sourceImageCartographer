...
//        console.log((((new Date).getTime() - sec) / 1000) + " sec. needed");
    ...
    loadImage: function(col, row, k) {
        ...
        var path;
        if (this.key != 0)
            path = 'http://localhost:8081/digilib/Scaler/' + this.facsimileViewer.getFacsimilePath() + '?dw=' + dw + '&amp;dh=' + dh + '&amp;wx=' + wx + '&amp;wy=' + wy + '&amp;ww=' + ww + '&amp;wh=' + wh + '&amp;mo=fit&amp;key=' + k;
        else
            path = 'http://localhost:8081/digilib/Scaler/' + this.facsimileViewer.getFacsimilePath() + '?dw=' + dw + '&amp;dh=' + dh + '&amp;wx=' + wx + '&amp;wy=' + wy + '&amp;mo=clip&amp;key=' + k;
